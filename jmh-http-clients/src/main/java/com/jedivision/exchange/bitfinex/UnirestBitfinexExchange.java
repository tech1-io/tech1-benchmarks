...
public class UnirestBitfinexExchange extends BitfinexExchange {
    private static final Logger LOGGER = LoggerFactory.getLogger(UnirestBitfinexExchange.class);
    ...
    public void ticker() throws IOException, UnirestException {
        ...
        LOGGER.debug("Bitfinex [Unirest] ticker: " + ticker);
    }
    ...
    public void orderBook() throws IOException, UnirestException {
        ...
        LOGGER.debug("Bitfinex [Unirest] orderBook: " + orderBook);
    }
    ...
    public void trades() throws IOException, UnirestException {
        ...
        LOGGER.debug("Bitfinex [Unirest] trades: " + trades);
    }
}
